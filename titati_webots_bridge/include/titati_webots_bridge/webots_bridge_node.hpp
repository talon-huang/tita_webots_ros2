...
private:
  ...
  std::shared_ptr<rclcpp::Publisher<std_msgs::msg::String>> fsm_publisher_;
  std::shared_ptr<realtime_tools::RealtimePublisher<std_msgs::msg::String>> realtime_fsm_publisher_;

  std::shared_ptr<WebotsKeyboard> webots_keyboard_;
  int base_time_step_;
};
